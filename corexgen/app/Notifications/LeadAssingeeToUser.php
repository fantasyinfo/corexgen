...
class LeadAssingeeToUser extends Notification implements ShouldQueue
{
    use Queueable;
     ...
     */
    public function __construct($lead, $assigneeBy,$assigneeTo, $mailSettings)
    {
        $this->lead = $lead;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('New Lead Assignee')
            ->view('emails.lead-assignee', [
                'lead' => $this->lead,

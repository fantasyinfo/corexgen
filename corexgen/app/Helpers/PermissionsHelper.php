...
class PermissionsHelper
{
    ...
    public static function initializePermissions()
    {
        self::$PERMISSIONS_IDS = [
            ...
            self::$plansPermissionsKeys['COMPANIES'] => [851 => 'CREATE', 852 => 'READ', 853 => 'READ_ALL', 854 => 'UPDATE', 855 => 'DELETE', 856 => 'IMPORT', 857 => 'EXPORT', 858 => 'FILTER', 859 => 'CHANGE_STATUS', 860 => 'VIEW'],

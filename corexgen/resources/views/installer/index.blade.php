    ...
    <div class="container mx-auto px-4 ">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex flex-col items-center mb-8">
                ...
                <div class="mt-4 w-24 h-1 bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 rounded-full"></div>
            </div>
            ...
            <div class="mb-8">
                <div class="flex justify-between relative">
                    ...
                    <div class="absolute top-5 left-0 right-0 h-0.5 bg-gray-200 dark:bg-gray-700 -z-1">
                        <div class="progress-line h-full bg-hostinger-primary transition-all duration-300" style="width: 0%"></div>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
                ...
                <form id="installerForm" class="p-6">
                    ...
                    <div id="step3" class="step-content hidden">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input name="db_host" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="localhost">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Database Port</label>
                                <input name="db_port" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="3306">
                            </div>
                            <div class="col-span-2">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Database Name</label>
                                <input name="db_name" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Username</label>
                                <input name="db_username" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Password</label>
                                <input type="password" name="db_password" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="step4" class="step-content hidden">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input name="smtp_host" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">SMTP Port</label>
                                <input name="smtp_port" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">SMTP Username</label>
                                <input name="smtp_username" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">SMTP Password</label>
                                <input type="password" name="smtp_password" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Encryption</label>
                                <select name="smtp_encryption" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input name="mail_from_address" type="email" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2">
                                <label class="block text-sm font-medium mb-2 dark:text-white">From Name</label>
                                <input name="mail_from_name" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="step5" class="step-content hidden">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2">
                                ...
                                <input name="site_name" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Admin Name</label>
                                <input name="name" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Admin Email</label>
                                <input name="admin_email" type="email" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div class="col-span-2">
                                <label class="block text-sm font-medium mb-2 dark:text-white">Admin Password</label>
                                <input name="admin_password" type="password" class="w-full px-4 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 flex justify-between">
                        <button type="button" id="prevBtn" class="px-6 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 hidden">
                            <i class="fas fa-arrow-left mr-2"></i>Previous
                        </button>
                        <button type="button" id="nextBtn" class="px-6 py-2 bg-hostinger-primary text-white rounded hover:bg-hostinger-secondary">
                            Next<i class="fas fa-arrow-right ml-2"></i>
                        </button>
                        <button type="submit" id="submitBtn" class="px-6 py-2 bg-hostinger-accent text-white rounded hover:bg-green-600 hidden">
    ...
    <div id="alertModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full">
            ...
            <div class="flex justify-end">
                <button onclick="closeAlertModal()" class="px-4 py-2 bg-hostinger-primary text-white rounded hover:bg-hostinger-secondary">
                    OK
                </button>
            </div>
        </div>
...
function showSuccessModal(title, htmlContent) {
    ...
    successModal.className = 'success-modal relative p-8 w-full max-w-3xl text-center bg-white rounded-2xl shadow-2xl animate__animated animate__fadeInDown';
        ...
        form.addEventListener('submit', async (e) => {
            ...
            return false;
                ...
                if (data.status === 'success') {
                    ...
                    showSuccessModal('Installation Completed Successfully!', successMessageContent);

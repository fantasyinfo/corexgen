...
@section('content')
    ...
    <div class="container-fluid ">
        ...
        <div class="card mb-4 border-0 pb-0 lead-header-card">
            <div class="card-body">
                @include('dashboard.companies.components._header')
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#payments">
                                <i class="fas fa-money me-2"></i>Payments
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#subscriptions">
                                <i class="fas fa-seedling me-2"></i>Subscriptions
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="card-body mt-0 pt-0">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="details">
                            ...
                            <div class="row g-4" id="viewDetails">
                                <div class="col-lg-7 main-content-view">
                                    <div class="row">
                                        @include('dashboard.companies.components.viewpartials._basic')
                                    
                                    </div>
                                    @include('dashboard.companies.components.viewpartials._address')
                                ...
                                <div class="col-lg-4 sidebar-view">
                                    @include('dashboard.companies.components.viewpartials._sidebar')
                                </div>
                        ...
                        <div class="tab-pane fade" id="payments">
                            @include('dashboard.companies.components._payments')
                        </div>

                        <div class="tab-pane fade" id="subscriptions">
                            @include('dashboard.companies.components._subscriptions')
                        </div>
                    </div>
                </div>
            </div>

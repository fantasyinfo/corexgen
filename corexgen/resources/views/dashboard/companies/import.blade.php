    ...
    <div class="container-fluid">
        <div class="">
            ...
            <div class="shadow-sm rounded">
                ...
                @if ( hasPermission('COMPANIES.IMPORT'))
                    <h5>{{ __('Bulk Import Companies Sample CSV Format') }}</h5>
                    ...
                    <div class="action-buttons my-4">
                        ...
                        <a class="btn btn-primary btn-xl" href="#" data-bs-toggle="modal"
                            ...
                            <i class="fas fa-upload me-2"></i> {{ __('crud.Import Companies Lists') }}
                        </a>

                        <!-- Secondary actions -->
                        <a class="btn btn-outline-primary btn-xl" href="/importcsv/companies.csv" target="_blank"

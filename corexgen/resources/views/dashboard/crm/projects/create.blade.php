                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group type="text" name="title" id="projectTitle"
                                        placeholder="{{ __('Web Development in Laravel') }}" value="{{ old('title') }}"
                            ...
                            <div class="row mb-4 align-items-center" id="billing_type">
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" value="Hourly" name="billing_type"
                                            id="Hourly" checked>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="billing_type" value="One-Time"
                                            id="One-Time">
                            ...
                            <div class="row mb-4 align-items-center" id="per_hour_cost">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group-prepend-append step="0.001"
                                        ...
                                        append="{{ getSettingValue('Currency Code') }}" type="number" name="per_hour_cost"
                                        id="perHourCost" placeholder="{{ __('99') }}"
                            ...
                            <div class="row mb-4 align-items-center" id="one_time_cost" style="display:none;">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group-prepend-append step="0.001"
                                        prepend="{{ getSettingValue('Currency Symbol') }}"
                                        append="{{ getSettingValue('Currency Code') }}" type="number" name="one_time_cost"
                                        id="perHourCost" placeholder="{{ __('99') }}"
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group type="date" name="start_date" id="startDate"
                                        value="{{ old('start_date') }}" required class="custom-class" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <input type="range" name="progress" class="form-range" id="progressInput"
                                                name="progress" min="0" max="100" value="10">
                                        </div>
                                        <div class="col-md-2">
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group type="number" name="time_spent" id="timeSpent"
                                        placeholder="{{ __('2') }}" value="{{ old('time_spent') }}"
                                        class="custom-class" />
                                </div>
                            </div>

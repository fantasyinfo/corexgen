        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <form id="projectForm" action="{{ route(getPanelRoutes('projects.update')) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <p class="fw-bold mb-0 me-4">
                                    <span class="d-block mb-2">{{ __('projects.Update Project') }}</span>
                                    <span
                                        class="fs-12 fw-normal text-muted text-truncate-1-line">{{ __('crud.Please add correct information') }}</span>
                                </p>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-plus"></i> <span>{{ __('projects.Update Project') }}</span>
                                </button>
                            </div>
                                ...
                                <div class="tab-pane fade show active" id="general" role="tabpanel">
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <x-form-components.input-group type="text" name="title" id="projectTitle"
                                                ...
                                                value="{{ old('title', $project->title) }}" required class="custom-class" />
                                        </div>
                                    </div>
                                            ...
                                            <select name="client_id" id="client_id" class="form-select searchSelectBox">
                                                @foreach ($clients as $item)
                                                    ...
                                                    <option value="{{ $item->id }}"
                                                        {{ old('client_id', $project->client_id) == $item->id ? 'selected' : '' }}>
                                                        {{ $nameAndEmail }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <div class="form-check me-3">
                                                <input class="form-check-input" type="radio" value="Hourly"
                                                    name="billing_type" id="Hourly"
                                                    {{ $project->billing_type == 'Hourly' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="billing_type"
                                                    ...
                                                    {{ $project->billing_type == 'One-Time' ? 'checked' : '' }}>
                                    ...
                                    <div class="row mb-4 align-items-center" id="per_hour_cost">
                                        ...
                                        <div class="col-lg-8">
                                            <x-form-components.input-group-prepend-append step="0.001"
                                                ...
                                                value="{{ old('per_hour_cost',$project->per_hour_cost) }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center" id="one_time_cost" style="display:none;">
                                        ...
                                        <div class="col-lg-8">
                                            <x-form-components.input-group-prepend-append step="0.001"
                                                ...
                                                value="{{ old('one_time_cost',$project->one_time_cost) }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <x-form-components.input-group type="number" name="estimated_hours"
                                                ...
                                                value="{{ old('estimated_hours',$project->estimated_hours) }}" class="custom-class" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <x-form-components.input-group type="number" name="time_spent"
                                                ...
                                                value="{{ old('time_spent', $project->time_spent) }}" class="custom-class" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <x-form-components.dropdown-with-profile :title="'Select Team Members'" :options="$teamMates"
                                                ...
                                                :selected="old('assign_to',$project->assignees->pluck('id')->toArray())"
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <x-form-components.textarea-group name="description" id="desc"
                                            placeholder="Describe the project details" value="{{ old('description',$project->description) }}"

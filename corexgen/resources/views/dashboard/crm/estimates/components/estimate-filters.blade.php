@if (hasPermission('USERS.FILTER'))
    <div class="filter-sidebar" id="filterSidebar">
        ...
        <div class="filter-sidebar-content">
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label for="clientFilter" class="mb-2 ">{{ __('estimates.Select Client') }}</label>
                    <select name="typable_id" class="form-select searchSelectBox" id="clientFilter" data-filter="client_id">
                        <option value="">{{ __('estimates.Client') }}</option>
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label for="leadFilter" class="mb-2 ">{{ __('estimates.Select Lead') }}</label>
                    <select name="typable_id" class="form-select searchSelectBox" id="leadFilter" data-filter="lead_id">
                        <option value="">{{ __('estimates.Lead') }}</option>
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label for="statusFilter" class="mb-2 ">{{ __('estimates.All Statuses') }}</label>
                    <select name="status" class="form-select" id="statusFilter" data-filter="status">
                        <option value="">{{ __('estimates.All Statuses') }}</option>
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label for="dateFilter" class="mb-2 ">{{ __('estimates.Date') }}</label>
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label for="vdateFilter" class="mb-2 ">{{ __('estimates.Valid Till') }}</label>

                                        ...
                                        @foreach ($customFields as $cf)
                                            @Switch($cf['field_type'])
                                                ...
                                                @case('time')
                                                    <div class="row mb-4" id="company_name_div">
                                                        <div class="col-lg-4">
                                                            <x-form-components.input-label for="{{ $cf['field_name'] }}"
                                                        ...
                                                        <div class="col-lg-8">
                                                            <x-form-components.input-group type="{{ $cf['field_type'] }}"
                                                                ...
                                                                id="{{ $cf['field_name'] }}"
                                                                placeholder="Please Enter {{ ucfirst($cf['field_label']) }}"
                                                ...
                                                @case('select')
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-select" name="custom_fields[{{ $cf['id'] }}]"
                                                ...
                                                @case('textarea')
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <x-form-components.textarea-group
                                                                name="custom_fields[{{ $cf['id'] }}]"
                                                                id="{{ $cf['field_name'] }}"
                                                                placeholder="Please Enter {{ ucfirst($cf['field_label']) }}"
                                                                value="{{ old('custom_fields.' . $cf['id'], '') }}"

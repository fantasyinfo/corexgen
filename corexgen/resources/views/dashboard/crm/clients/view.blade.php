...
@section('content')
    ...
    <div class="container-fluid ">
        ...
        <div class="card mb-4 border-0 pb-0 lead-header-card">
            <div class="card-body">
                @include('dashboard.crm.clients.components._header')
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="details">
                            @if (isset($permissions['UPDATE']) && hasPermission(strtoupper($module) . '.' . $permissions['UPDATE']['KEY']))
                                <div class="d-flex my-3 justify-content-lg-end gap-2 ">
                                    ...
                                    <button form="clientEditForm" title="Update" data-toggle="tooltip" type="submit" id="updateBtn" class="btn btn-primary">
                            ...
                            <div class="row g-4" id="viewDetails">
                                <div class="col-lg-7 main-content-view">
                                    <div class="row">
                                        @include('dashboard.crm.clients.components.viewpartials._basic')
                                        @include('dashboard.crm.clients.components.viewpartials._additional')
                                    </div>
                                    @include('dashboard.crm.clients.components.viewpartials._address')
                                    @include('dashboard.crm.clients.components.viewpartials._details')
                                </div>
                                <div class="col-lg-1 divider-container">
                                    <div class="divider"></div>
                                </div>
                                <div class="col-lg-4 sidebar-view">
                                    @include('dashboard.crm.clients.components.viewpartials._sidebar')
                                </div>
                            </div>
                            <!-- Edit Details -->
                            <div class="row g-4" id="editDetails">
                                <form id="clientEditForm" method="POST" action="{{ route(getPanelRoutes('clients.update')) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 main-content-view">
                                            <div class="row">
                                                @include('dashboard.crm.clients.components.editpartials._basic')
                                                @include('dashboard.crm.clients.components.editpartials._additional')
                                            </div>
                                  
                                            @include('dashboard.crm.clients.components.editpartials._details')
                                        </div>
                                        <div class="col-lg-1 divider-container">
                                            <div class="divider"></div>
                                        </div>
                                        <div class="col-lg-4 sidebar-view">
                                            @include('dashboard.crm.clients.components.editpartials._sidebar')
                                        </div>
                                    </div>
                                </form>
                            </div>

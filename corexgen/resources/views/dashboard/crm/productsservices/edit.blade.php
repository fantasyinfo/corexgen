                        ...
                        <div class="card-body general-info">
                            <div class="mb-5 d-flex align-items-center justify-content-between">
                                <p class="fw-bold mb-0 me-4">
                                    <span class="d-block mb-2">{{ __('products.Update Product') }}</span>
                                    <span
                                        class="fs-12 fw-normal text-muted text-truncate-1-line">{{ __('crud.Please add correct information') }}</span>
                                </p>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-plus"></i> <span>{{ __('products.Update Product') }}</span>
                                </button>
                            </div>
                            ...
                            <div class="tab-content mt-4" id="companyTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="general" role="tabpanel">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                            <x-form-components.input-label for="cgt_id" class="custom-class">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <x-form-components.input-group type="number" class="custom-class"
                                                id="unit" name="unit" placeholder="{{ __('Product qty...') }}"

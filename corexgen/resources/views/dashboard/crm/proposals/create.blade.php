                        ...
                        <div class="card-body general-info">
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <select name="template_id" id="template_id" class="form-select">
                                        <option value="null">Select Template (optional)</option>
                            ...
                            <div class="row mb-4 align-items-center">
                                <div class="col-lg-4">
                                    ...
                                    <x-form-components.input-label for="valid_date" class="custom-class" required>
                                        {{ __('proposals.Valid Till') }}
                                    </x-form-components.input-label>
                                </div>
                                <div class="col-lg-8">
                                    <x-form-components.input-group type="date" class="custom-class" id="valid_date"
                                        name="valid_date" value="{{ old('valid_date') }}" required />
                                </div>
                            </div>
                            <div class="row mb-4 align-items-center">

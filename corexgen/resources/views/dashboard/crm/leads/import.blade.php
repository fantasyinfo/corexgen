    ...
    <div class="container-fluid">
        <div class="">
            ...
            <div class="shadow-sm rounded">
                ...
                @if (hasPermission('LEADS.IMPORT'))
                    <h5>{{ __('Bulk Import Leads Sample CSV Format') }}</h5>
                    ...
                    <div class="action-buttons my-4">
                        ...
                        <a class="btn btn-primary btn-xl" href="#" data-bs-toggle="modal"
                            ...
                            <i class="fas fa-upload me-2"></i> {{ __('crud.Import Leads Lists') }}
                        </a>

                        <!-- Secondary actions -->
                        <a class="btn btn-outline-primary btn-xl" href="/importcsv/leads.csv" target="_blank"
                        ...
                        <a href="{{ route('download.cgt', ['type' => 'leads_groups', 'relation' => 'leads']) }}"
                            class="btn btn-outline-primary btn-xl">
                            <i class="fas fa-download me-2"></i> {{ __('crud.Download Group ID') }}
                        </a>
                        <a href="{{ route('download.cgt', ['type' => 'leads_sources', 'relation' => 'leads']) }}"
                            class="btn btn-outline-primary btn-xl">
                            <i class="fas fa-download me-2"></i> {{ __('crud.Download Source ID') }}
                        </a>
                        <a href="{{ route('download.cgt', ['type' => 'leads_status', 'relation' => 'leads']) }}"
                            class="btn btn-outline-primary btn-xl">
                            <i class="fas fa-download me-2"></i> {{ __('crud.Download Status ID') }}
                        </a>
                    </div>

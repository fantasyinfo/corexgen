                ...
                <div class="mt-4">
                    <ul class="nav nav-tabs" id="leadDetailsTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="detailsShow-tab" data-bs-toggle="tab"
                                data-bs-target="#detailsShow" type="button" role="tab">Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="assignees-tab" data-bs-toggle="tab" data-bs-target="#assignees"
                                type="button" role="tab">Assignees</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="comments-tab" data-bs-toggle="tab" data-bs-target="#comments"
                                type="button" role="tab">Comments</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade show active" id="detailsShow" role="tabpanel">
                        ...
                        <div class="tab-pane fade" id="comments" role="tabpanel">
                            @include('dashboard.crm.leads.components.modal._comments')
                        </div>
                        <div class="tab-pane fade" id="files" role="tabpanel">
                            @include('dashboard.crm.leads.components.modal._files')
                        </div>
                        <div class="tab-pane fade" id="activity" role="tabpanel">
                            @include('dashboard.crm.leads.components.modal._activity')
                        </div>
                    </div>
                </div>
            </div>

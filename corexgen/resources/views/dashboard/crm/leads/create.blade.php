                        ...
                        <div class="card-body">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <p class="fw-bold mb-0 me-4">
                                    <span class="d-block mb-2">{{ __('leads.Create New Lead') }}</span>
                                    <span
                                        class="fs-12 fw-normal text-muted text-truncate-1-line">{{ __('crud.Please add correct information') }}</span>
                                </p>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-plus"></i> <span>{{ __('leads.Create Lead') }}</span>
                                </button>
                            </div>
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-select" name="preferred_contact_method"
                                                ...
                                                @foreach (['Email', 'Phone', 'In-Person'] as $pcm)
                                                    <option value="{{ $pcm }}"
                                                        {{ old('preferred_contact_method.pcm') == $pcm ? 'selected' : '' }}>
                                                        {{ $pcm }}</option>
                                                @endforeach
                                            </select>
                                        </div>

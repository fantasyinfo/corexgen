    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="file-upload-area mb-3 kanban-border">
                <form id="mediaForm" method="POST" action="{{ route(getPanelRoutes('tasks.attachment.create')) }}"
                                        ...
                                        <div class="attachment-actions">
                                            ...
                                            @if ($deletePermission)
                                                <button class="btn btn-danger btn-sm delete-attachment"
                                                    data-url="{{ route(getPanelRoutes('tasks.attachment.destroy'), ['id' => $attachment->id]) }}">

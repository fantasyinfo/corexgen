    ...
    <div class="row profile-container">
        ...
        <div class="col-md-4 p-0">
            <div class="profile-header">
                ...
                <h6 class="mb-1">{{ $company->cname }}</h6>
                {{-- <p class="mb-0">Name: {{ $company->users[0]['name'] }}</p> --}}
            </div>
            ...
            <div class="address-section">
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        ...
                        <div class="contact-value">
                            {{ @$company->addresses->street_address }}<br>
                            {{ @$company->addresses->city->name }}, {{ @$company->addresses->country->code }}
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <div class="contact-label">Plan</div>
                        <div class="contact-value">{{ $company->plans->name }}</div>
                    </div>
                </div>
            </div>
        </div>

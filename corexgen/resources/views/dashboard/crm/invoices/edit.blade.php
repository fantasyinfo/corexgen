        ...
        <div class="row">
            <div class="justify-content-md-center col-lg-12">
                <div class="card stretch stretch-full">
                    <form id="invoiceFieldsForm" action="{{ route(getPanelRoutes('invoices.update')) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body general-info">
                            <div class="mb-5 d-flex align-items-center justify-content-between">
                                <p class="fw-bold mb-0 me-4">
                                    <span class="d-block">{{ __('invoices.Update Invoice') }}</span>
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> {{ __('invoices.Update Invoice') }}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group-prepend-append
                                        ...
                                        placeholder="{{ __('0001') }}" value="{{ old('_id', $invoice->_id) }}" required disabled="true" />
                                </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <x-form-components.input-group type="date" placeholder="Select Date" class="custom-class" id="due_date"
                                        name="due_date" value="{{ old('due_date',$invoice->due_date) }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <x-form-components.textarea-group name="notes" id="notes"
                                    ...
                                    value="{{ old('notes',$invoice->notes) }}" class="custom-class notes" />
                                </div>
                            </div>
                            @include('dashboard.crm.invoices.components._itemUpdate')
                        </div>
                    </form>
                </div>
            </div>

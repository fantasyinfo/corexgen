...
@section('title', 'Project Assignee')

@section('content')
    <div style="margin-bottom: 30px;">
        <p style="margin-bottom: 20px; font-size: 16px; color: #4a5568;">
            A new project <strong style="color: #2d3748;">{{ $project->title }}</strong> has been assignee to You (<strong
        ...
        <div style="text-align: center; margin-top: 30px;">
            <a href="{{ route(getPanelRoutes('projects.view'), ['id' => $project->id]) }}"

            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                    <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                        <img src="{{
                            App::getLocale() == 'hi' ? 
                            asset('assets/vendors/img/flags/4x3/in.svg') : 
                            asset('assets/vendors/img/flags/4x3/us.svg')
                        ...
                        <div class="language-items-wrapper">
                            ...
                            <div class="row px-4 pt-3">
                                ...
                                <div class="col-sm-4 col-6 language_select {{App::getLocale() == 'en' ? 'active' : ''}}">
                                    <a href="{{ url('/setlang/en') }}" class="d-flex align-items-center gap-2">
                                        <div class="avatar-image avatar-sm"><img src="{{asset('assets/vendors/img/flags/1x1/us.svg')}}" alt="" class="img-fluid" /></div>
                                        <span>English</span>
                                    </a>
                                </div>
                              
                                <div class="col-sm-4 col-6 language_select {{App::getLocale() == 'hi' ? 'active' : ''}}">
                                    <a href="{{ url('/setlang/hi') }}" class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="text-dark mb-0">{{ucwords(auth()->user()->name)}} <span class="badge bg-soft-success text-success ms-1">{{getRoleName(auth()->user()->role_id)}}</span></h6>

...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="max-w-3xl mx-auto">
            ...
            <form action="{{ isset($post) ? route('blog.posts.update', $post) : route('blog.posts.store') }}" method="POST"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('blog.posts.index') }}" class="text-gray-600 hover:text-gray-800">
                        Cancel
                    </a>
                </div>
            </form>
